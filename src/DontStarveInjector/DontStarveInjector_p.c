...
typedef struct _DontStarveInjector_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } DontStarveInjector_MIDL_TYPE_FORMAT_STRING;

typedef struct _DontStarveInjector_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } DontStarveInjector_MIDL_PROC_FORMAT_STRING;

typedef struct _DontStarveInjector_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } DontStarveInjector_MIDL_EXPR_FORMAT_STRING;
...
extern const DontStarveInjector_MIDL_TYPE_FORMAT_STRING DontStarveInjector__MIDL_TypeFormatString;
extern const DontStarveInjector_MIDL_PROC_FORMAT_STRING DontStarveInjector__MIDL_ProcFormatString;
extern const DontStarveInjector_MIDL_EXPR_FORMAT_STRING DontStarveInjector__MIDL_ExprFormatString;
...
static const DontStarveInjector_MIDL_PROC_FORMAT_STRING DontStarveInjector__MIDL_ProcFormatString =
    {
        0,
        {
...
static const DontStarveInjector_MIDL_TYPE_FORMAT_STRING DontStarveInjector__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
static const MIDL_STUBLESS_PROXY_INFO IComponentRegistrar_ProxyInfo =
    {
    &Object_StubDesc,
    DontStarveInjector__MIDL_ProcFormatString.Format,
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    DontStarveInjector__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * _DontStarveInjector_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IComponentRegistrarProxyVtbl,
    0
};

const CInterfaceStubVtbl * _DontStarveInjector_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IComponentRegistrarStubVtbl,
    0
};

PCInterfaceName const _DontStarveInjector_InterfaceNamesList[] = 
{
    "IComponentRegistrar",
    0
};

const IID *  _DontStarveInjector_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _DontStarveInjector_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _DontStarveInjector, pIID, n)

int __stdcall _DontStarveInjector_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_DontStarveInjector_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo DontStarveInjector_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _DontStarveInjector_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _DontStarveInjector_StubVtblList,
    (const PCInterfaceName * ) & _DontStarveInjector_InterfaceNamesList,
    (const IID ** ) & _DontStarveInjector_BaseIIDList,
    & _DontStarveInjector_IID_Lookup, 
    1,
    2,
